...
class ShowOnCompletedOrders extends StatelessWidget {
  final Restaurant restaurant;
  ShowOnCompletedOrders({this.restaurant});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance
            ...
            .where('onCompleted', isEqualTo: true)
            .snapshots(),
                ...
                Container(
                  ...
                  child: orders.isNotEmpty
                      ...
                      : Padding(
                          ...
                          child: Text(
                            translator
                                .translate('There are no requests currently'),
